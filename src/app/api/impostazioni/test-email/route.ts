...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await sendNotificationMail({
      to: toEmail,
      subject: "Test Notifiche Tavoly — Taaaac Cloud Mail Engine",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 25px; border: 1px solid #bbf7d0; border-radius: 16px; background: #ffffff;">
          <h2 style="color: #059669; margin-top: 0;">🍽️ Tavoly — Test Notifica Riuscito!</h2>
          <p style="color: #334155; font-size: 14px; line-height: 1.5;">
            Questo messaggio conferma che il sistema di notifiche e conferme tavolo di Tavoly è operativo e sincronizzato con il gateway SPF/DKIM certificato Taaaac.
          </p>
