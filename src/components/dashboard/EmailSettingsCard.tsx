  ...
  return (
    <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-4">
      ...
      <p className="text-xs text-slate-600 leading-relaxed">
        Le conferme dei tavoli prenotati e i riepiloghi ai clienti vengono recapitati istantaneamente dai server certificati Taaaac con reputazione SPF e conformità DMARC garantita.
      </p>

      <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2 text-xs">
        <div className="flex justify-between items-center text-slate-500">
          <span>Casella Mittente Sito:</span>
          <span className="font-mono text-emerald-700 font-semibold">noreply@tavoly.taaaac.eu</span>
        </div>
        <div className="flex justify-between items-center text-slate-500">
